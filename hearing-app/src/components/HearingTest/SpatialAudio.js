...
export function SpatialCheck() {
    return (
      <div className="parent">
        <Link to="../spatial-test1" className="div4 btn-gradient btn-start">
        ...
        <div className="check2">
          <Link to="../spatial-check" className="btn-gradient btn-check1">
        ...
        <div className="check3">
          <Link to="../spatial-check" className="btn-gradient btn-check2">
            <div className="btn-container1">
              <div className="icon-container">
    ...
    return (
      <div className="test1-parent">
        ...
        <div className="test1-div4">
          ...
          <Link to="../spatial-test2" className="box2 btn-gradient btn-next">
    ...
    return (
      <div className="test1-parent">
        ...
        <div className="test1-div4">
          ...
          <Link to="../spatial-test3" className="box2 btn-gradient btn-next">
            <div className="hold-container">Next...</div>
          </Link>
        </div>
      </div>
    ...
    return (
      <div className="test1-parent">
        ...
        <div className="test1-div4">
          ...
          <Link to="../spatial-test4" className="box2 btn-gradient btn-next">
            <div className="hold-container">Next...</div>
          </Link>
        </div>
      </div>
    ...
    return (
      <div className="test1-parent">
        ...
        <div className="test1-div4">
          ...
          <Link to="../spatial-test-end" className="box2 btn-gradient btn-next">
            <div className="hold-container">Next...</div>
          </Link>
        </div>
      </div>
